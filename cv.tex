...
\item Created, documented, and maintained several virtual systems
  and virtualized existing infrastructure systems with vSphere\slash KVM (using remote Linux administration almost exclusively).
...
\project{
  ...
  technology  = {(NetworkX, PyYAML) Python},
  technical,
}
...
\project{
  ...
  link        = https://www.github.com/vermiculus/bits,
  ghkey       = vermiculus/c-util (private),
  technical,
  technology  = C,
  date        = \daterange*{2012}{Current; Stagnant}
}
